        ...
        <div class="inner-column row">
            ...
            <div id="center_column" class="inner-bg col-xs-12 col-sm-8 col-lg-9">
                {{Form::open(array('url'=>'member/update','method'=>'put','class'=>'form-horizontal'))}}
                    ...
                    <div class="form-group">
                        <label for="inputPassword" class="col-md-2 control-label">Konfirmasi Password</label>
                        <div class="col-md-4">
                            <input type="password" class="form-control" name="password_confirmation" id="inputPassword" placeholder="Konfirmasi Password Baru">
                        </div>
                    </div>
                    <hr />
                    <div class="form-group">
